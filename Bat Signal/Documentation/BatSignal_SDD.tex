...
\textnormal{BatSignal is a distributed sensor network designed to collect audio and analyze the captures for ques indicating distress or emergency, and to alert staff of such situations. The system is designed to be physically scaled according to the needs of the location of installation.}
...
\subsubsection{Wi Pi Module}
\textnormal{
\begin{center}
\begin{tabularx}{\textwidth}{ | l | X | }
	\hline
	\multicolumn{2}{ | c | }{\textbf{Wi Pi Module Specifications}} \\
	\hline
		& \\
	\hline
\end{tabularx}
